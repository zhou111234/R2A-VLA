...
def test_libero_r2a_inputs():
    ...
    # Verify shapes
    assert images["base_0_rgb"].shape == (
        4,
        224,
        224,
        3,
    ), f"Expected (4, 224, 224, 3), got {images['base_0_rgb'].shape}"
    assert images["left_wrist_0_rgb"].shape == (
        4,
        224,
        224,
        3,
    ), f"Expected (4, 224, 224, 3), got {images['left_wrist_0_rgb'].shape}"
    assert images["right_wrist_0_rgb"].shape == (
        4,
        224,
        224,
        3,
    ), f"Expected (4, 224, 224, 3), got {images['right_wrist_0_rgb'].shape}"
